...
public class KeyPairConverterTest {
    ...
    public void convertSingleAzureVaultKeyPair() {
        ...
        try (var staticKeyVaultServiceFactory = mockStatic(KeyVaultServiceFactory.class)) {
            ...
            when(keyVaultService.getSecret(any(GetSecretData.class)))
                .thenReturn("publicSecret").thenReturn("privSecret");
    ...
    public void convertSingleAwsVaultKeyPair() {
        ...
        try (var staticKeyVaultServiceFactory = mockStatic(KeyVaultServiceFactory.class)) {
            ...
            staticKeyVaultServiceFactory.when(() -> KeyVaultServiceFactory.getInstance(KeyVaultType.AWS))
                .thenReturn(keyVaultServiceFactory);
    ...
    public void convertSingleHashicorpVaultKeyPair() {
        ...
        try (var staticKeyVaultServiceFactory = mockStatic(KeyVaultServiceFactory.class)) {
            ...
            staticKeyVaultServiceFactory.when(() -> KeyVaultServiceFactory.getInstance(KeyVaultType.HASHICORP))
                .thenReturn(keyVaultServiceFactory);
