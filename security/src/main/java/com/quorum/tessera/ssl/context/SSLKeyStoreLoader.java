...
final class SSLKeyStoreLoader {
    ...
    static KeyManager[] fromJksKeyStore(Path keyStoreFile, String keyStorePassword)
    ...
    static TrustManager[] fromJksTrustStore(Path trustStoreFile, String trustStorePassword)
