...
public class ServerSSLContextFactoryTest {
  ...
  public void getServerKeyStorePasswordOnlySetInConfigReturnsConfigValue() {
    ...
    when(envVarProvider.getEnvAsCharArray(EnvironmentVariables.SERVER_KEYSTORE_PWD))
        .thenReturn(null);
  ...
  public void getServerTrustStorePasswordOnlySetInConfigReturnsConfigValue() {
    ...
    when(envVarProvider.getEnvAsCharArray(EnvironmentVariables.SERVER_TRUSTSTORE_PWD))
        .thenReturn(null);
    when(envVarProvider.getEnvAsCharArray(
