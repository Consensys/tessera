...
public class ClientSSLContextFactoryTest {
    ...
    public void createFromConfigWithDefaultKnownServers() throws URISyntaxException {
        ...
        verify(environmentVariableProvider).getEnvAsCharArray(EnvironmentVariables.CLIENT_TRUSTSTORE_PWD);
    ...
    public void getClientKeyStorePasswordOnlySetInGlobalEnvReturnsGlobalEnvValue() {
        ...
        when(environmentVariableProvider.getEnvAsCharArray(EnvironmentVariables.CLIENT_KEYSTORE_PWD)).thenReturn(password);
    ...
    public void getClientKeyStorePasswordOnlySetInPrefixedEnvReturnsPrefixedEnvValue() {
        ...
        String prefixedEnvionmentVar = envVarPrefix.concat("_").concat(EnvironmentVariables.CLIENT_KEYSTORE_PWD);

        when(environmentVariableProvider.getEnvAsCharArray(prefixedEnvionmentVar))
                .thenReturn(password);
    ...
    public void getClientKeyStorePasswordSetInConfigAndGlobalEnvReturnsConfigValue() {
        ...
        when(environmentVariableProvider.getEnvAsCharArray(EnvironmentVariables.CLIENT_KEYSTORE_PWD)).thenReturn(globalEnvVal);
    ...
    public void getClientKeyStorePasswordSetInConfigAndPrefixedEnvReturnsPrefixedEnvValue() {
        ...
        when(environmentVariableProvider.getEnvAsCharArray(envVarPrefix + "_" + EnvironmentVariables.CLIENT_KEYSTORE_PWD))
        ...
        verify(environmentVariableProvider).getEnvAsCharArray(envVarPrefix + "_" + EnvironmentVariables.CLIENT_KEYSTORE_PWD);
    ...
    public void getClientTrustStorePasswordOnlySetInConfigReturnsConfigValue() {
        ...
        when(environmentVariableProvider.getEnvAsCharArray(EnvironmentVariables.CLIENT_TRUSTSTORE_PWD)).thenReturn(null);
        when(environmentVariableProvider.getEnvAsCharArray(envVarPrefix + "_" + EnvironmentVariables.CLIENT_TRUSTSTORE_PWD))
                .thenReturn(null);
    ...
    public void getClientTrustStorePasswordOnlySetInGlobalEnvReturnsGlobalEnvValue() {
        ...
        when(environmentVariableProvider.getEnvAsCharArray(EnvironmentVariables.CLIENT_TRUSTSTORE_PWD)).thenReturn(password);
        when(environmentVariableProvider.getEnvAsCharArray(envVarPrefix + "_" + EnvironmentVariables.CLIENT_TRUSTSTORE_PWD))
                .thenReturn(null);
    ...
    public void getClientTrustStorePasswordOnlySetInPrefixedEnvReturnsPrefixedEnvValue() {
        ...
        verify(environmentVariableProvider).getEnvAsCharArray(envVarPrefix + "_" + EnvironmentVariables.CLIENT_TRUSTSTORE_PWD);
    }
    ...
    public void getClientTrustStorePasswordSetInConfigAndGlobalEnvReturnsConfigValue() {
        ...
        when(environmentVariableProvider.getEnvAsCharArray(EnvironmentVariables.CLIENT_TRUSTSTORE_PWD)).thenReturn(globalEnvVal);
