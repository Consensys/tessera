...
public class ServerConfigTest {
    ...
    public void serverUri() throws URISyntaxException {
        ...
        ServerConfig config =
                new ServerConfig(AppType.P2P, true, serverAddress, CommunicationType.REST, null, null, null);
    ...
    public void bindingUri() throws URISyntaxException {
        ...
        ServerConfig config =
                new ServerConfig(
                        AppType.P2P, true, serverAddress, CommunicationType.REST, null, null, "http://somedomain:9000");
    ...
    public void bindingUriInvalidUri() {
        new ServerConfig(AppType.P2P, true, "&@€~:*&2:-1", CommunicationType.REST, null, null, "&@€~:*&2:")
                .getBindingUri();
    }
    ...
    public void sslNotNullButTlsFlagOff() {
        ...
        ServerConfig serverConfig =
                new ServerConfig(AppType.P2P, true, "somedomain:8989", CommunicationType.REST, sslConfig, null, null);
    ...
    public void nullAdvertisedUrlIsSameAsBindAddress() {
        final ServerConfig serverConfig =
                new ServerConfig(AppType.P2P, true, "somedomain:8989", CommunicationType.REST, null, null, null);
    ...
    public void unixSocketConfig() {
        final ServerConfig serverConfig =
                new ServerConfig(AppType.P2P, true, "unix:/bogis.ipc", CommunicationType.REST, null, null, null);
