...
public class TesseraAppFactoryTest {
    ...
    public void createOtherExisting() {
        Optional<TesseraApp> result = TesseraAppFactory.create(CommunicationType.WEB_SOCKET, AppType.THIRD_PARTY);
    ...
    public void createNonExisting() {
        Optional<TesseraApp> result = TesseraAppFactory.create(CommunicationType.WEB_SOCKET, AppType.P2P);
