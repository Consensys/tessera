...
public class StagingEntityDAOTest {
    ...
    public static void initialiseTransactions(EntityManager entityManager) {
    ...
    public void init() throws Exception {
        ...
        initialiseTransactions(entityManager);
    ...
    public void testRetrieveTransactionByHash() {
        StagingEntityDAOTest.testRetrieveTransactionByHash(stagingEntityDAO);
    }

    @Test
    public void testDeleteTransactionByHash() {
        StagingEntityDAOTest.testDeleteTransactionByHash(stagingEntityDAO);
    }

    @Test
    public void testUpdate() {
        StagingEntityDAOTest.testUpdate(stagingEntityDAO, entityManager);
    }

    @Test
    public void testCleanupStagingData() {
        testCleanStagingData(stagingEntityDAO);
    }
