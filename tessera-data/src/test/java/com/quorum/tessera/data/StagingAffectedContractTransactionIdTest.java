...
public class StagingAffectedContractTransactionIdTest {
    ...
    public void testEquals() {
        ...
        StagingAffectedContractTransactionId id3 = new StagingAffectedContractTransactionId(source, new MessageHashStr());
        StagingAffectedContractTransactionId id4 = new StagingAffectedContractTransactionId(new MessageHashStr(), affected);
