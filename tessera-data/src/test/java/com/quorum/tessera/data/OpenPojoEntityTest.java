...
public class OpenPojoEntityTest {
  ...
  public static Set<Map.Entry<Class<? extends Serializable>, Validator>> entities() {
    ...
    Validator defaultValidatorForEntityWithOutAnnoyingPrimativeFields = validatorBuilder.build();

    return Map.of(
            MessageHash.class, validatorBuilder.with(new NoPrimitivesRule()).build(),
            EncryptedRawTransaction.class, defaultValidatorForEntityWithOutAnnoyingPrimativeFields,
            EncryptedTransaction.class, defaultValidatorForEntityWithOutAnnoyingPrimativeFields,
            StagingTransaction.class, defaultValidatorForEntityWithOutAnnoyingPrimativeFields)
        .entrySet();
  }
}
