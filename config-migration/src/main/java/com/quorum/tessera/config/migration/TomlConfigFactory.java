...
public class TomlConfigFactory {
    ...
    public ConfigBuilder create(InputStream configData, ArgonOptions options, String... filenames) {
        ...
        final Integer port = Optional.ofNullable(toml.getLong("port")).map(Long::intValue).orElse(null);
        ...
        final Optional<List<String>> tlsserverchainnames =
                Optional.ofNullable(toml.getList("tlsserverchain", emptyList()));
        ...
        final Optional<List<String>> tlsclientchainnames =
                Optional.ofNullable(toml.getList("tlsclientchain", emptyList()));
