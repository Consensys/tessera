...
public class LegacyCliAdapterTest {
  ...
  public void withoutCliArgsAllConfigIsSetFromTomlFile() throws Exception {
    ...
    assertThat(sslConfig.getServerTlsCertificatePath().toString())
    ...
    assertThat(sslConfig.getClientTlsCertificatePath().toString())
  ...
  public void providingCliArgsOverridesTomlFileConfig() throws Exception {
    ...
    assertThat(config.getPeers())
        .hasSize(1)
        .extracting("url")
        .containsExactlyInAnyOrder("http://others");
    assertThat(config.getKeys().getKeyData())
        .hasSize(1)
    ...
    assertThat(sslConfig.getServerTrustCertificates().get(0).toString())
        .isEqualTo("override/serverchain.file");
    assertThat(sslConfig.getServerTlsKeyPath().toString())
    ...
    assertThat(sslConfig.getClientTrustCertificates().get(0).toString())
        .isEqualTo("override/clientchain.file");
    assertThat(sslConfig.getClientTlsKeyPath().toString())
  ...
  @Test
  public void ifWorkDirCliOverrideIsProvidedThenItIsAppliedToBothTomlAndCliSetParameters()
      throws Exception {
    ...
    Path sampleFile =
        Paths.get(getClass().getResource("/sample-toml-no-nulls-tls-off.conf").toURI());
    Map<String, Object> params = new HashMap<>();
    ...
    assertThat(sslConfig.getClientTrustCertificates())
        .hasSize(2)
        .containsExactlyInAnyOrder(
            Paths.get("override/clientchain1"), Paths.get("override/clientchain2"));
  ...
  public void urlWithPortSet() throws Exception {
    ...
    assertThat(result).isNotNull();
    assertThat(result.getConfig()).isPresent();
    assertThat(result.getConfig().get().getP2PServerConfig().getServerAddress())
  ...
  public void keyDataProvidedButNoPasswordProvidedThenNoMessagePrintedToConsole() {
    ...
    KeyDataBuilder keyDataBuilder =
        KeyDataBuilder.create().withPublicKeys(publicKeys).withPrivateKeys(privateKeys);
  ...
  @Test
  public void
      ifTomlWorkDirNotProvidedWithoutOverrideWorkDirThenDefaultWorkDirUsedOnOverridenValues() {
    String socketFilepath = "path/to/socket.ipc";
  ...
  @Test
  public void
      ifTomlWorkDirNotProvidedButOverrideWorkDirIsThenOverrideWorkDirUsedOnOverridenValues() {
    String overrideWorkDir = "override";
    String socketFilepath = "path/to/socket.ipc";
  ...
  public void applyOverrides() throws Exception {
    ...
    final List<Peer> overridePeers =
        Arrays.asList(
            new Peer("http://otherone.com:9188/other"),
            new Peer("http://yetanother.com:8829/other"));
    ...
    final Config result =
        instance.applyOverrides(builderWithValidValues, KeyDataBuilder.create()).build();
    ...
    assertThat(sslConfig.getClientTlsCertificatePath())
        .isEqualTo(Paths.get("workdirOverride/tlsclientcert.cert"));
    assertThat(sslConfig.getServerTlsCertificatePath())
  ...
  public void applyOverridesNullValues() {
    ...
    assertThat(realServerConfig.getServerAddress())
        .isEqualTo(expectedServerConfig.getServerAddress());
    assertThat(realServerConfig.getBindingAddress())
        .isEqualTo(expectedServerConfig.getBindingAddress());

    assertThat(this.getUnixSocketServerAddress(result))
        .isEqualTo(this.getUnixSocketServerAddress(expectedValues));
    ...
    assertThat(sslConfig.getClientTrustCertificates())
        .containsExactly(Paths.get("sslClientTrustCertificates"));
