...
public class ConfigBuilderTest {
  ...
  public void buildValid() {
    ...
    assertThat(unixServer.getServerAddress())
        .isEqualTo("unix:" + Paths.get("somepath.ipc").toAbsolutePath());
    ...
    assertThat(keyData)
        ...
        .containsExactly(Paths.get("private"));
    assertThat(keyData)
        .isNotNull()
        .extracting("publicKeyPath")
        .containsExactly(Paths.get("public"));
    ...
    assertThat(sslConfig.getClientKeyStorePassword())
        .isEqualTo("sslClientKeyStorePassword".toCharArray());
