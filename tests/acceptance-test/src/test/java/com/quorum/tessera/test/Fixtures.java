...
public class Fixtures {
    ...
    public static final URI NODE2_URI = UriBuilder.fromUri(SCHEME_AND_HOST).port(8081).build();
    
    public static final URI NODE3_URI = UriBuilder.fromUri(SCHEME_AND_HOST).port(8082).build();
