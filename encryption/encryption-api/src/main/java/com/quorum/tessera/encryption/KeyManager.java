...
public interface KeyManager {
    ...
    /**
     * Fetches the public key that corresponds to the given private key This means that the returned public key is under
     * control of the current node (i.e. it is one of our keys)
     *
    ...
    /**
     * Fetches the private key that corresponds to the given public key This means that the returned private key is
     * under control of the current node (i.e. it is one of our keys)
     *
    ...
    /**
     * Returns the default public key of this node if a transaction is sent that doesn't have a sender.
     *
     * <p>Must return the same key each time during a single run, but no guarantee is made about which key is returned
    ...
    /**
     * Returns a set of public keys that all transactions should be sent to in addition to the declared recipients
     *
