...
/**
 * This tool takes in a transaction hash and produces the cURL call needed to retrieve that transaction via Quorum.
 *
 * <p>It converts the Base64 hash to its Hex format, and then formats a cmdline call to be pasted.
 */
