...
/**
 * Provides key encryption and decryption for private keys into the
 * representation expected by a private key file
 */
public interface KeyEncryptor {
    ...
    /**
     * Encrypts a private key using the given password and returns a JSON object
     * that can be interpreted when decrypting
     *
