...
public class AzureVaultKeyGeneratorTest {
  ...
  public void keysSavedInVaultWithProvidedVaultIdAndCorrectSuffix() {
    ...
    final ArgumentCaptor<AzureSetSecretData> captor =
        ArgumentCaptor.forClass(AzureSetSecretData.class);
    ...
    AzureSetSecretData expectedDataPriv =
        new AzureSetSecretData(privVaultId, priv.encodeToBase64());
