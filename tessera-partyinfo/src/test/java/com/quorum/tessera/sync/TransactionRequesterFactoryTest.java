...
public class TransactionRequesterFactoryTest {
    ...
    @Test
    public void createBatchTransactionRequester() {
        TransactionRequesterFactory transactionRequesterFactory = TransactionRequesterFactory.newFactory();
        ...
        TransactionRequester transactionRequester = transactionRequesterFactory.createBatchTransactionRequester(config);

        assertThat(transactionRequester).isNotNull()
            .isExactlyInstanceOf(BatchTransactionRequesterImpl.class);
    }
}
