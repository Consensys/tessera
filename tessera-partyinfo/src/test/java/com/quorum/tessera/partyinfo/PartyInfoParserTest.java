...
public class PartyInfoParserTest {
    ...
    private final int[] sampleDataOne = new int[]{
        ...
        0, 0, 0, 0, 0, 0, 0, 5, //length of ledgerid
    ...
    public void toUsingSameInfoFromFixture() {
        ...
        assertThat(byteBuffer.getLong()).isEqualTo(5L);

        byte[] ledgerBytes = new byte[5];
        byteBuffer.get(ledgerBytes);

        final String ledgerId = new String(ledgerBytes);
        assertThat(ledgerId).isEqualTo(partyInfo.getLedgerId());
