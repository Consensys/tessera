...
public interface ResendBatchPublisher {
    ...
    /**
     * Formats, encodes and publishes encrypted messages using the target public
     * key as the identifier, instead of the URL
     *
     * @param payload the pre-formatted payload object (i.e. with all recipients
     * still present)
