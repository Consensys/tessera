...
public class ConfigurationFactory {
    ...
    /**
     * Returns a configuration class that populates configuration from various
     * sources. The property returned is based on the first source that contains
     * that property from the following list:
     *
     * system properties (passed in via -D...=...) environment properties (from
     * the OS) commandline properties configuration file properties (file
     * location specified by -Dconfig.location=...) default properties
     *
