...
public class AzureKeyVaultService
  ...
  AzureKeyVaultService(
      KeyVaultConfig keyVaultConfig, AzureKeyVaultClientDelegate azureKeyVaultClientDelegate) {
  ...
  public String getSecret(AzureGetSecretData azureGetSecretData) {
    ...
    if (azureGetSecretData.getSecretVersion() != null) {
      ...
      secretBundle =
          azureKeyVaultClientDelegate.getSecret(vaultUrl, azureGetSecretData.getSecretName());
    }
