...
public class AzureKeyVaultClientCredentials extends KeyVaultCredentials {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(AzureKeyVaultClientCredentials.class);
  ...
  AzureKeyVaultClientCredentials(
      String clientId, String clientSecret, ExecutorService executorService) {
    ...
    try {
      if (Objects.isNull(authenticationContext)) {
        this.authenticationContext =
            new AuthenticationContext(authorization, false, executorService);
      }
