...
public class HashicorpKeyVaultSpringService implements KeyVaultService {
    ...
    public HashicorpKeyVaultSpringService(HashicorpKeyVaultConfig keyVaultConfig, VaultTemplate vaultTemplate) {
