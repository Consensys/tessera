 ...
 * @see {Enclave}
 */
public class EnclaveDelegate {

    private static final Logger LOGGER = LoggerFactory.getLogger(EnclaveDelegate.class);
    ...
    public EnclaveDelegate(Enclave enclave, Base64Decoder base64Decoder,PayloadEncoder payloadEncoder) {
