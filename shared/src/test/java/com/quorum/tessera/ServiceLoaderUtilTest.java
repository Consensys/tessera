...
public class ServiceLoaderUtilTest {
  ...
  public void noServiceFound() {
    final Optional<ServiceLoaderUtilTest> result =
        ServiceLoaderUtil.load(ServiceLoaderUtilTest.class);
  ...
  public void noServiceFoundWithStream() {
    final Stream<ServiceLoaderUtilTest> result =
        ServiceLoaderUtil.loadAll(ServiceLoaderUtilTest.class);
