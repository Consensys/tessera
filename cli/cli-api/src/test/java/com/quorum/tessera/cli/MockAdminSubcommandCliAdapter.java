 ...
 * subcommand to other CLI adapters. Its setup mimics that of the AdminCliAdapter subcommand and
 * should be used in cases where testing CLI args containing "admin" are handled correctly.
 */
