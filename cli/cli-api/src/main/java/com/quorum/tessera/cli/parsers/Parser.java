 ...
 *
 * <p>The actions may have side-effects, and may choose to return a value
 *
...
public interface Parser<T> {
    ...
    /**
     * Parses the CLI arguments and performs actions based upon whether the arguments relevant to it are present or not
     *
     * @param commandLine the command line object that has parsed the configuration
     * @return the output of the parser, if any
     * @throws Exception if there is a problem with the supplied configuration, any exception could be thrown
     */
