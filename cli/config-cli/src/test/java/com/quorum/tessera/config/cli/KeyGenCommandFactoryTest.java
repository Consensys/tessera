...
public class KeyGenCommandFactoryTest {
    ...
    public void create() throws Exception {
        ...
        try(
            var staticKeyGeneratorFactory = mockStatic(KeyGeneratorFactory.class);
            var staticKeyDataMarshaller = mockStatic(KeyDataMarshaller.class)
            ) {

            staticKeyGeneratorFactory.when(KeyGeneratorFactory::create).thenReturn(mock(KeyGeneratorFactory.class));
            staticKeyDataMarshaller.when(KeyDataMarshaller::create).thenReturn(mock(KeyDataMarshaller.class));
