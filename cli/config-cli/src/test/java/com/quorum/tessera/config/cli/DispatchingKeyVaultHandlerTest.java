...
public class DispatchingKeyVaultHandlerTest {
    ...
    public static List<Map<String,?>> configs() {
        return List.of(
            ...
            Map.of(
                "resultType",DefaultKeyVaultConfig.class,
                "configOptions",new KeyVaultConfigOptions() {
                    @Override
            ...
            Map.of(
                "resultType", HashicorpKeyVaultConfig.class,
                "configOptions",new KeyVaultConfigOptions() {
                    @Override
                    public KeyVaultType getVaultType() {
            ...
            Map.of(
                "resultType", AzureKeyVaultConfig.class,
                "configOptions",new KeyVaultConfigOptions() {
                    @Override
                    public KeyVaultType getVaultType() {
