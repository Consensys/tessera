...
public class TesseraCommandTest {
    ...
    public void testArg() throws Exception {
        ...
        Optional<CommandLine.ITypeConverter> converterOptional = (Optional<CommandLine.ITypeConverter>) config.get("convertor");
