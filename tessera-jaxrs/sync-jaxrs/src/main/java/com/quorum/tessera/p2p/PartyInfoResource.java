...
public class PartyInfoResource {
    ...
    public PartyInfoResource(
            ...
            PartyInfoValidatorCallback partyInfoValidatorCallback,
        ...
        this.partyInfoValidatorCallback = requireNonNull(partyInfoValidatorCallback);
    ...
    public Response validate(byte[] payloadData) {
        final byte[] result = partyInfoService.unencryptSampleData(payloadData);
