...
public class PrivacyGroupResourceTest {
    ...
    public void testCreatePrivacyGroupMinimal() {
        ...
        verify(privacyGroupManager)
                .createPrivacyGroup(strArgCaptor.capture(), strArgCaptor.capture(), any(), any(), any(byte[].class));
    ...
    public void testFindPrivacyGroup() {
        ...
        final Response response =
                jersey.target("findPrivacyGroup").request().post(Entity.entity(req, MediaType.APPLICATION_JSON));
