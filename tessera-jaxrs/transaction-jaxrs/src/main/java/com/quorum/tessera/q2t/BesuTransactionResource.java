...
public class BesuTransactionResource {
    ...
    public BesuTransactionResource(TransactionManager transactionManager, PrivacyGroupManager privacyGroupManager) {
    ...
    public Response receive(@Valid final ReceiveRequest request) {
        ...
        MessageHash transactionHash =
                Optional.of(request).map(ReceiveRequest::getKey).map(base64Decoder::decode).map(MessageHash::new).get();
